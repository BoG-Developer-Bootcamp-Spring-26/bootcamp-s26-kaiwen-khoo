...
function toLetterGrade(numGrade) {
  if (numGrade >= 90 && numGrade <= 100) return "A";
  if (numGrade >= 80 && numGrade < 90) return "B";
  if (numGrade >= 70 && numGrade < 80) return "C";
  if (numGrade >= 60 && numGrade < 70) return "D";
  if (numGrade >= 0 && numGrade < 60)  return "F";
  return "INVALID";
}
...
function findLongestWord(string) {
  return string.split(" ").reduce((maxLength, word) => {
